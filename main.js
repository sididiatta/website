const creatNewProjectCard = (title, imageUrl, text) => {
...
const handleSubmit = (event) => {
    ...
    const formTitle = document.querySelector('#project-tittle').value
    const formImageUrl = document.querySelector('#project-img-link').value
    const formText = document.querySelector('#project-text').value
    const newProjectCard = creatNewProjectCard(formTitle, formImageUrl, formText)
